 ...
 */
package com.SunriseStudio.TeamTCG.openmc;

import com.SunriseStudio.TeamTCG.openmc.gui.screen.HUDScreen;
import com.SunriseStudio.TeamTCG.openmc.gui.screen.Screen;
import com.SunriseStudio.TeamTCG.openmc.gui.screen.TitleScreen;
import com.SunriseStudio.TeamTCG.openmc.render.renderer.ContentWorldRenderer;
...
import com.SunriseStudio.TeamTCG.openmc.util.timer.Timer;
...
public class Minecraft implements Runnable{
    ...
    public void init() throws LWJGLException {
        ...
        LogHandler.log("registering blocks", LogHandler.Errors.INFO,"startup");
    ...
    public void render(float a) {
        ...
        int screenWidth = this.width * 240 / this.height;
        int screenHeight = this.height * 240 / this.height;
        GLUtil.setupOrthogonalCamera(0,0, this.width, this.height, this.width/GameSetting.instance.GUIScale, this.height/GameSetting.instance.GUIScale);
