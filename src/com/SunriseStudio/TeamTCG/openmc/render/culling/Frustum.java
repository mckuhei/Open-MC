package com.SunriseStudio.TeamTCG.openmc.render.culling;
...
public class Frustum {
    ...
    public boolean isVisible(AABB aabb) {
        ...
        //return this.frustumIntersection.intersectAab((float)aabb.x0, (float)aabb.y0, (float)aabb.z0, (float)aabb.x1, (float)aabb.y1, (float)aabb.z1)>0.0;
    }
}
